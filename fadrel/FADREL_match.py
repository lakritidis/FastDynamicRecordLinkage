...
class FADRELMatchingPhase:
    ...
    def initialize(self) -> None:
        ...
        if os.path.isdir(self.classifier_path):
            print("\tFound a pre-trained BERT Sequence Classifier, loading...")
        ...
        if os.path.isfile(self.cluster_data_path):
            ...
            self.clusters = pickle.load(data_file)
            data_file.close()
        else:
    ...
    def run(self, test_df : pd.DataFrame) -> None:
        ...
        mm.perform_matching(query_set, test_df, self.title_column, self.label_column)
